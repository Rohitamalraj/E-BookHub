      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-700 mb-12 leading-relaxed font-medium">
            Join thousands of readers worldwide who've built their digital library,
            <br className="hidden md:block" />
            discovered new authors, and found stories that changed their lives.
          </p>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-gray-600 font-medium">Happy Readers</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-gray-600 font-medium">Books Available</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl md:text-4xl font-black text-gray-900 mb-1">50+</div>
              <div className="text-sm md:text-base text-gray-600 font-medium">Genres</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl md:text-4xl font-black text-gray-900 mb-1">4.9★</div>
              <div className="text-sm md:text-base text-gray-600 font-medium">Avg. Rating</div>
            </div>
          </motion.div>
          ...
          >
            <p className="text-sm text-gray-500 mb-4 font-medium">TRUSTED BY READERS WORLDWIDE</p>
            <div className="flex flex-wrap justify-center items-center gap-8 text-gray-400">
              ...
              <span className="text-sm font-semibold">🔒 DRM PROTECTED</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
