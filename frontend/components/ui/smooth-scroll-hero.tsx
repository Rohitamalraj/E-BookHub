          ...
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Happy Readers</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Books Available</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Genres</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">4.9★</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Avg. Rating</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">TRUSTED BY READERS WORLDWIDE</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                ...
                <span className="text-xs font-semibold">🔒 DRM PROTECTED</span>
              </div>
            </div>
          </div>
        </motion.div>
